...
<body class="bg-dark text-white">
    ...
    <main>
        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-end py-3 mb-4">
                ...
                <ul class="nav nav-pills">
                    <?php if (session('logged_in') && session('role') === "Pelanggan") { ?>
                        <li class="nav-item"><a href="
                            <?= base_url('pelanggan/pesan-lapangan') ?>" class="nav-link text-white
                    ...
                    <?php } else { ?>
                        ...
                        <li class="nav-item"><a href="<?= base_url('/login') ?>" class="nav-link text-white">Masuk</a></li>
                    <?php } ?>
                </ul>
            </header>
        </div>
